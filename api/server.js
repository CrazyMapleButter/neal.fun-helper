            ...
            messages: [
                {
                    ...
                    content: [
                        {
                            type: "text",
                            text: "Look at this image and identify all the numbers you can see. If you see mathematical expressions or equations, solve them first. Then sort all numbers from least to greatest and format your response as a clean, easy-to-read list like this:\n\nSorted numbers (least to greatest):\n1. [smallest number]\n2. [next number]\n3. [next number]\n...and so on\n\nDo not include any LaTeX formatting, backslashes, or mathematical notation in your final answer. Use plain text only."
                        },
                        {
                            type: "image_url",
                            image_url: {
