            ...
            messages: [
                {
                    ...
                    content: [
                        {
                            type: "text",
                            text: "Look at this image and identify all the numbers you can see. Then sort these numbers from least to greatest and provide only the sorted list. If you see any mathematical expressions or equations, solve them first, then include the results in your sorting."
                        },
                        {
                            type: "image_url",
                            image_url: {
